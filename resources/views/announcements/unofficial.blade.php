...
<head>
    ...
    <title>Unofficial Announcements - UTHM Bulletin Board</title>
    ...
    <style>
        ...
        /* Unofficial announcement specific */
        .unofficial-banner {
...
<body class="bg-gray-50">
            ...
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center space-x-3 overflow-hidden">
                    ...
                    <div class="sidebar-text">
                        ...
                        <p class="text-xs text-gray-500">Unofficial Announcements</p>
                    </div>
                </div>
    ...
    <div id="main-content" class="content-collapsed min-h-screen content-transition">
            ...
            <div class="max-w-full mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between h-16">
                    ...
                    <div class="flex items-center">
                        <h1 class="text-xl font-bold text-gray-900">Unofficial Announcements</h1>
                        <span class="mx-2 text-gray-400">/</span>
                        <span class="text-gray-600">Community Posts & Notices</span>
                    </div>
                    
                    <!-- Quick Actions -->
                    <div class="flex items-center space-x-4">
                        <!-- Quick Create Button -->
                        @if(in_array($user->role, ['admin', 'staff', 'student']))
                        <div class="relative hidden md:block">
                            <a href="{{ route('announcements.create') }}?type=unofficial" 
                               class="bg-amber-600 text-white px-4 py-2 rounded-lg hover:bg-amber-700 transition flex items-center">
        ...
        <div class="py-8">
            <div class="max-w-full mx-auto px-4 sm:px-6 lg:px-8">
                <!-- Unofficial Announcements Banner -->
                <div class="unofficial-banner rounded-xl shadow-lg mb-8 p-6">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center">
                            ...
                            <div>
                                <h2 class="text-3xl font-bold">Community Announcements</h2>
                                <p class="mt-2 text-white/90">Posts from students, clubs, and community members at UTHM</p>
                            </div>
                        </div>
                ...
                <div class="mb-8">
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                        <div>
                            <h2 class="text-2xl font-bold text-gray-900">Community Posts & Notices</h2>
                            <p class="mt-2 text-gray-600">Share and discover announcements from fellow students and community members</p>
                        </div>
                        @if(in_array($user->role, ['admin', 'staff', 'student']))
                        <div class="mt-4 sm:mt-0">
                            <a href="{{ route('announcements.create') }}?type=unofficial" 
                               class="inline-flex items-center px-5 py-3 bg-amber-600 text-white font-medium rounded-lg hover:bg-amber-700 transition-colors shadow-md">
                ...
                <div class="mb-8 bg-amber-50 border border-amber-200 rounded-xl shadow-sm p-5">
                    <div class="flex items-start">
                        <div class="bg-amber-100 p-3 rounded-lg mr-4 shrink-0">
                ...
                <div class="mb-8 bg-amber-50 border border-amber-200 rounded-xl shadow-sm p-5">
                    <div class="flex items-start">
                        ...
                        <div>
                            <h3 class="font-bold text-gray-900 text-lg">Community Guidelines</h3>
                            <p class="text-gray-700 text-sm mt-1">
                                Please keep posts respectful and relevant to the UTHM community. 
                                All community posts are subject to moderation. 
                                <a href="#" class="text-amber-700 hover:text-amber-800 font-medium">Read full guidelines</a>
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="mb-8 bg-white rounded-xl shadow p-4">
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                        <div class="flex flex-wrap gap-2">
                            ...
                            <button onclick="filterAnnouncements('clubs')" 
                                    class="px-4 py-2 bg-pink-50 text-pink-700 rounded-lg text-sm font-medium hover:bg-pink-100">
                                <i class="fas fa-users mr-2"></i>Clubs & Societies
                            </button>
                        </div>
                        ...
                        <div class="flex items-center">
                            <div class="relative">
                                ...
                                <input type="text" 
                                       ...
                                       class="pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent w-full sm:w-64">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    @if($hasOfficialColumn)
                        ...
                        @forelse($announcements as $announcement)
                            @if(!$announcement->is_official)
                                <div class="announcement-card bg-white rounded-xl shadow hover:shadow-lg transition-shadow overflow-hidden border border-gray-200 border-l-4 border-l-amber-500" 
                                        ...
                                        <div class="flex items-center justify-between mt-4 pt-4 border-t border-gray-100">
                                            <div class="flex items-center text-sm text-gray-500">
                                                <div class="w-8 h-8 bg-amber-100 rounded-full flex items-center justify-center mr-2">
                                                    @if($announcement->author->role === 'student')
                                                ...
                                                <div>
                                                    <span class="font-medium">{{ $announcement->author->name ?? 'Community Member' }}</span>
                                                    <div class="flex items-center mt-1">
                                                        <span class="text-xs text-gray-500">
                                                            @if($announcement->author->role === 'student')
                                                                <i class="fas fa-graduation-cap mr-1"></i>Student
                                                            @elseif($announcement->author->role === 'staff')
                                            ...
                                            <a href="{{ route('announcements.show', $announcement) }}" 
                                               class="inline-flex items-center px-4 py-2 bg-amber-50 text-amber-700 font-medium rounded-lg hover:bg-amber-100 transition-colors">
                                                View Details
                            ...
                            @endif
                        @empty
                            <!-- No Unofficial Announcements Message -->
                            <div class="col-span-2 text-center py-12">
                                <div class="inline-block p-6 bg-amber-100 rounded-full mb-4">
                                    <i class="fas fa-users text-amber-400 text-4xl"></i>
                                </div>
                                <h3 class="text-xl font-medium text-gray-900 mb-2">No Community Posts Yet</h3>
                                <p class="text-gray-600 mb-6">Be the first to share something with the UTHM community!</p>
                                @if(in_array($user->role, ['admin', 'staff', 'student']))
                                <div class="mt-8">
                                    <a href="{{ route('announcements.create') }}?type=unofficial" 
                                       class="inline-flex items-center px-6 py-3 bg-amber-600 text-white font-medium rounded-lg hover:bg-amber-700 transition-colors shadow-lg">
        ...
        <!-- Floating "Add Community Post" Button -->
        @if(in_array($user->role, ['admin', 'staff', 'student']))
        <a href="{{ route('announcements.create') }}?type=unofficial" 
           class="floating-add-btn bg-amber-600 text-white p-4 rounded-full shadow-lg hover:bg-amber-700 transition-colors hover:shadow-xl">
