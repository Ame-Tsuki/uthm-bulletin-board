            ...
            <div class="p-6 h-full flex flex-col justify-between">
                <div>
                    ...
                    <nav class="space-y-1 mt-2">
                        ...
                        <a href="{{ route('admin.users.view') }}" class="flex items-center sidebar-link rounded-xl {{ request()->routeIs('admin.users.*') ? 'active' : '' }}">
                ...
                <aside class="absolute left-0 top-0 h-full w-72 bg-gray-900 text-white p-6 flex flex-col justify-between shadow-2xl">
                    <div>
                        ...
                        <nav class="space-y-1 mt-2">
                            ...
                            <a href="{{ route('admin.users.view') }}" class="flex items-center sidebar-link rounded-xl py-3 {{ request()->routeIs('admin.users.*') ? 'active' : '' }}">
